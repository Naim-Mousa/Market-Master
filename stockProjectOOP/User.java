...
public class User implements Trader {
     ...
     * =======================
     * CONSTRUCTOR: User
     * INPUT: budget (double) - the initial budget for the user.
     * PROCESSING: Initializes the user with the given budget and an empty
     * portfolio.
     * OUTPUT: none
     * =======================
     */
     ...
     * =======================
     * METHOD: buyShares
     * INPUT: stock (Stock) - the stock to buy, shares (int) - number of shares to
     * buy.
     * PROCESSING: Buys the specified number of shares of the given stock if the
     * budget allows.
     ...
     * =======================
     * METHOD: sellShares
     * INPUT: stock (Stock) - the stock to sell, shares (int) - number of shares to
     * sell.
     * PROCESSING: Sells the specified number of shares of the given stock if the
     * shares are owned.
     * Updates the user's budget and portfolio accordingly.
     * OUTPUT: boolean - TRUE if the transaction is successful, FALSE otherwise.
     * =======================
     ...
     * PROCESSING: Searches for a PortfolioItem in the user's portfolio by stock
     * name.
     ...
     * isBuying (boolean) - Flag indicating if the operation is a buy (TRUE) or sell
     * (FALSE).
     * PROCESSING: Updates the portfolio to add a new item or update an existing
     * item based on the buy/sell operation.
     * OUTPUT: none
     * =======================
     */
